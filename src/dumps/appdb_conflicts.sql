...
CREATE TABLE `conflicts` (
  ...
  `conflict_status` enum('processing','fulfilled','rejected') NOT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`conflict_id`),
  UNIQUE KEY `conflict_id_UNIQUE` (`conflict_id`),
...
INSERT INTO `conflicts` VALUES (1,1,2,'bad treatment results','fulfilled','2023-10-31 00:00:00','2023-10-31 00:00:00'),(2,1,3,'My appointment was cancelled','processing','2023-10-31 00:00:00','2023-10-31 00:00:00');
